...
final class Plugin {
	...
	public function enqueue_admin_assets( string $hook ): void {
		...
		$data = array(
			...
			'strings'   => array(
				...
				'confirmConvertNow'         => __( 'Generate missing AVIF files now?', 'avif-local-support' ),
				'recommendDefaultsApplied'  => __( 'Recommended AVIF defaults applied (Quality 83, Speed 0).', 'avif-local-support' ),
					...
					'avifStarting'              => __( 'Starting AVIF generation...', 'avif-local-support' ),
					...
					'avifAlreadyRunning'        => __( 'A conversion job is already running. Progress is continuing in the background.', 'avif-local-support' ),
					'avifAlreadyScheduled'      => __( 'A conversion job is already queued. It will continue in the background shortly.', 'avif-local-support' ),
					'avifQueueFailed'           => __( 'Could not queue AVIF generation. Check WP-Cron and try again.', 'avif-local-support' ),
				...
				'missingFilesModalTitle'    => __( 'Files Without AVIF', 'avif-local-support' ),
	...
	public function render_admin_page(): void {
		...
		$settings = array(
			...
			'quality'           => (int) get_option( 'aviflosu_quality', 83 ),
			'speed'             => (int) get_option( 'aviflosu_speed', 0 ),
			'last_run'          => get_option( 'aviflosu_last_run_summary', array() ),
		);
	...
	public function handle_reset_defaults(): void {
		...
		update_option( 'aviflosu_logs_max_entries', 50 );
